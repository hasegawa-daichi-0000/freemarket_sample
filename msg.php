...
debug('取得したパラメータID:' . print_r($m_id, true));
//DBから掲示板とメッセージデータを取得
  ...
  if (empty($err_msg)) {
    ...
    try {
      ...
      if ($stmt) {
        ...
        debug('連絡掲示板へ遷移します');
        header("Location: " . $_SESSION['PHP_SELF'] . '?m_id=' . $m_id); //自分自身に遷移する
      }
    } catch (Exception $e) {
      ...
      <div class="msg-info">
        ...
        <div class="product-info">
          ...
          <div class="right">
            ...
            取引金額：<span class="price">¥<?php number_format(sanitize($productInfo['price'])); ?></span><br>
